...
\hline
\rowcolor{gray!20}
\textbf{Característica} & \textbf{Thread 1.3.1}\footnote{El piloto se implementó con Thread 1.3.0 (ESP32-C6 OpenThread stack, ESP-IDF 5.1). Thread 1.4.0, publicado en octubre 2024, incorpora mejoras de seguridad y eficiencia energética recomendadas para despliegue productivo (véase §4.4).} & \textbf{Zigbee 3.0} & \textbf{Bluetooth Mesh} \\
\hline
...
\item Desarrollo nodos IoT: ESP32-C6 Thread LwM2M + adaptador RS-485 DLMS/COSEM para lectura de medidores inteligentes.
\end{enumerate}
