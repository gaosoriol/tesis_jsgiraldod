...
\hline
\textbf{7. Aplicación} & LwM2M 1.2 & Gestión de dispositivos, objetos IPSO \\
\hline
\textbf{6. Presentación} & CBOR/TLV & Serialización eficiente de datos \\
\hline
\textbf{5. Sesión} & CoAP (RFC 7252) & Protocolo RESTful para constrained devices \\
\hline
\textbf{4. Transporte} & UDP & Transporte no orientado a conexión \\
\hline
\textbf{3. Red} & 6LoWPAN (RFC 6282) & Compresión headers IPv6, fragmentación \\
\hline
...
\hline
Sensing FE & Nodos ESP32-C6 Thread + interfaz RS485 para medidores EMSITECH (protocolo DLMS/COSEM) \\
\hline
