...
\centering
\small
\caption{MCS HaLow para 1 MHz channel width en Smart Energy}
\label{tab:halow-mcs}
\begin{tabular}{|p{1.5cm}|p{2.2cm}|p{1.8cm}|p{2.5cm}|p{2.5cm}|}
\hline
\rowcolor{gray!20}
\textbf{MCS} & \textbf{Modulation} & \textbf{Code Rate} & \textbf{Data Rate (Mbps)} & \textbf{Sensitivity (dBm)} \\
\hline
\textcolor{green}{0} & BPSK & 1/2 & \textcolor{green}{0.150} & \textcolor{blue}{-99} \\
\hline
\textcolor{green}{1} & QPSK & 1/2 & \textcolor{green}{0.300} & \textcolor{blue}{-96} \\
\hline
\textcolor{green}{2} & QPSK & 3/4 & \textcolor{green}{0.450} & \textcolor{blue}{-94} \\
\hline
\textcolor{blue}{3} & 16-QAM & 1/2 & \textcolor{blue}{0.600} & -91 \\
\hline
\textcolor{blue}{4} & 16-QAM & 3/4 & \textcolor{blue}{0.900} & -88 \\
\hline
...
\hline
8 & 256-QAM & 3/4 & 1.800 & \textcolor{red}{-77} \\
\hline
9 & 256-QAM & 5/6 & 2.000 & \textcolor{red}{-75} \\
\hline
10 & — & — & (Reservado) & — \\
\hline
\end{tabular}
