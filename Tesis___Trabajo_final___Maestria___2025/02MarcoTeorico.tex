...
Esta sección presenta los \textbf{fundamentos teóricos} de cada protocolo del stack, incorporando investigación reciente (2023-2025) sobre eficiencia energética~\cite{krawiecEnergyFootprintReliability2025}, compresión de headers~\cite{vanderveldenEvaluation6LoWPANGeneric2023}, protocolos de gestión de dispositivos~\cite{alkwiefiM2MProtocolsOverview2024}, y aplicabilidad específica para smart grids~\cite{devanagaviPerformanceEvaluationIoT2025}. El objetivo es proporcionar el \textbf{estado del arte actualizado} que fundamenta las decisiones arquitecturales presentadas posteriormente en el Capítulo~\ref{chap:arquitectura} (decisiones de diseño y resultados experimentales del sistema implementado) y Capítulo~\ref{chap:implementacion} (implementación de hardware y firmware específico del prototipo).
