...
\textheight22.5cm \topmargin0cm \textwidth16.5cm \headheight24pt
...
\include{00Objetivos}
\include{01Seccion01} % Introducción (802.3, 802.11ah, 802.15.4, etc.)
\include{02Seccion02} % Marco Teórico
\include{03Gateway} % Gateway (Software) - NUEVO
\include{04Arquitectura} % Arquitectura (Caso de Estudio) - NUEVO
\include{05Seccion05} % Conclusiones y trabajo futuro
\include{06Seccion06}
\include{07Seccion07}
