...
\include{03Arquitectura_NEW} % Arquitectura del Sistema Completo (Big Picture) - NUEVO ORDEN
\include{04Gateway_NEW} % Implementación de Componentes (Detalle Hardware/Software) - NUEVO ORDEN
