...
\begin{itemize}
    ...
    \item \textbf{Bridge Thread↔TB}: Traductor MQTT entre redes Thread y ThingsBoard
    \item \textbf{Apache Kafka}: Bus de mensajes para integración empresarial
\end{itemize}

Los archivos \texttt{docker-compose.yml} completos para OTBR, ThingsBoard Edge, PostgreSQL y servicios auxiliares se presentan en el Anexo B. Los scripts Python de implementación para el IEEE 2030.5 Server, el Bridge Thread↔ThingsBoard, y los productores/consumidores Kafka se documentan en el Anexo C.
