...
Los medidores inteligentes implementan los estándares IEC 62052/62053 (clase 1 o 2 según precisión requerida) con interfaz DLMS/COSEM sobre RS-485 o puerto óptico IEC 62056-21~\cite{basnetNetworkingPowerGrid2025,SmartHomeEnergy2024}. Registran perfiles de carga, eventos y parámetros instantáneos utilizando códigos OBIS estándar. Opcionalmente incorporan detección de manipulación (tamper) y capacidad de corte/reconexión remota~\cite{alsuwaidiSecuringSmartGrid2024}.
